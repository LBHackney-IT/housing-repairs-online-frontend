...
const PriorityList = ({ handleChange, values }) => {
  ...
  const options = [
    {
      value: 'gas-emergency/1',
      title: 'I can smell gas in or near the property in or near the property',
    },
    ...
    {
      value: 'emergency/6',
      title: 'I can\'t lock the doors or windows in my property',
    },
    { value: 'emergency/7', title: 'I have exposed wires or sockets' },
    {
      value: 'emergency/8',
      title: 'My carbon monoxide or smoke alarm is beeping',
    },
  ...
  return (
    <div className="govuk-grid-row" data-cy="priority-list">
