class Flow {
    ...
    this.flow = {
      ...
      'existing-repair': {
        ...
        nextStep: [
          ...
          {
            condition: 'existing',
            nextStep: 'not-eligible-previously-reported',
          },
        ],
      },
      communal: {
        prevStep: 'existing-repair',
        nextStep: [
      ...
      address: {
        ...
        nextStep: [
          ...
          {
            condition: 'invalidProperty',
            nextStep: 'not-eligible-invalid-property',
          },
        ],
      },
      'repair-location': {
        ...
        nextStep: [
          ...
          {
            condition: 'livingAreas',
            nextStep: 'repair-living-areas-problems',
          },
        ],
      },
      'repair-outside-problems': {
        prevSteps: 'repair-location',
        nextStep: [
          ...
          {
            condition: 'gatesAndPathways',
            nextStep: 'gates-and-pathways-problems',
          },
        ],
      },
      ...
      'gates-and-pathways-problems': {
        prevSteps: 'repair-outside-problems',
        nextStep: 'repair-description',
      },
      ...
      'repair-kitchen-problems': {
        prevStep: 'repair-location',
        nextStep: [
          {
            condition: 'cupboards',
            nextStep: 'repair-kitchen-cupboard-problems',
          },
      ...
      'repair-door-problems': {
        ...
        nextStep: [
          ...
          {
            condition: 'adjustingDoorAfterCarpetFitting',
            nextStep: 'not-eligible-non-emergency',
          },
        ],
      },
      ...
      'repair-bathroom-problems': {
        ...
        nextStep: [
          ...
          {
            condition: 'electricsExtractorCords',
            nextStep: 'repair-bathroom-electric-problems',
          },
          { condition: 'sink', nextStep: 'sink-problems' },
          { condition: 'windows', nextStep: 'repair-window-problems' },
          {
            condition: 'dampOrMould',
            nextStep: 'bathroom-damp-mould-problems',
          },
          {
            condition: 'damagedOrStuckDoors',
            nextStep: 'repair-door-problems',
          },
          {
            condition: 'showerIncludingTrayAndDoor',
            nextStep: 'repair-shower-problems',
          },
          {
            condition: 'damagedOrStuckDoors',
            nextStep: 'repair-door-problems',
      ...
      'repair-bedroom-problems': {
        ...
        nextStep: [
          {
            condition: 'electricsLightsSwitches',
            nextStep: 'repair-bedroom-lighting-problems',
          },
          {
            condition: 'wallsFloorsCeiling',
            nextStep: 'wall-floor-ceiling-problems',
          ...
          {
            condition: 'damagedOrStuckDoors',
            nextStep: 'repair-bedroom-door-problems',
          },
          { condition: 'dampOrMould', nextStep: 'damp-mould-problems' },
      ...
      'repair-living-areas-problems': {
        ...
        nextStep: [
          ...
          {
            condition: 'damagedOrStuckDoors',
            nextStep: 'repair-living-area-door-problems',
          },
          { condition: 'dampOrMould', nextStep: 'damp-mould-problems' },
      ...
      'repair-bathroom-electric-problems': {
        prevStep: 'repair-bathroom-problems',
        nextStep: [
      ...
      'repair-stairs-problems': {
        prevStep: 'repair-living-areas-problems',
        nextStep: 'repair-description',
      },
      ...
      'repair-bedroom-lighting-problems': {
        prevStep: 'repair-bedroom-problems',
        nextStep: 'repair-description',
      },
      ...
      'repair-description-damp': {
        prevStep: 'repair-kitchen-types',
        nextStep: [
      ...
      'repair-damp': {
        prevStep: 'repair-description-damp',
        nextStep: 'repair-description-damp-pipes',
      },
      'repair-description-damp-pipes': {
        prevStep: 'repair-damp',
        nextStep: 'repair-description',
      },
      'repair-description-damp-mold': {
        prevStep: 'repair-description-damp',
        nextStep: 'repair-description',
      },
      'repair-description-electrical': {
        prevStep: 'repair-kitchen-types',
        nextStep: [
          ...
          {
            condition: 'smoke-detector-beeping',
            nextStep: 'repair-description-electrical-smoke-alarm',
          },
          { condition: 'sockets', nextStep: 'repair-description' },
          {
            condition: 'carbon-monoxide-alarm',
            nextStep: 'repair-description-electrical-carbon-monoxide-alarm',
          },
          { condition: 'something-else', nextStep: 'repair-description' },
        ],
      },
      'repair-description-electrical-smoke-alarm': {
        prevStep: 'repair-description-electrical',
      },
      'repair-description-electrical-carbon-monoxide-alarm': {
        prevStep: 'repair-description-electrical',
      },
      'repair-description-heating-water': {
        prevStep: 'repair-kitchen-types',
        nextStep: [
          {
            condition: 'no-heating-or-hot-water',
            nextStep: 'repair-description-heating-water-emergency',
          },
          { condition: 'radiator-not-working', nextStep: 'repair-description' },
          {
            condition: 'radiator-coming-loose',
            nextStep: 'repair-description',
          },
      ...
      'repair-description-leak': {
        ...
        nextStep: [
          {
            condition: 'dripping-from-wall-or-ceiling',
            nextStep: 'repair-description-leak-electrics',
          },
          {
            condition: 'containable-sink-leak',
            nextStep: 'repair-description',
          },
          { condition: 'tap-dripping-water', nextStep: 'repair-description' },
          { condition: 'running-tap', nextStep: 'emergency-repair' },
          {
            condition: 'non-containable-radiator-leak',
            nextStep: 'repair-description',
          },
          { condition: 'something-else', nextStep: 'repair-description' },
        ],
      },
      'repair-description-leak-electrics': {
        prevStep: 'repair-description-leak',
        nextStep: [
          {
            condition: 'dripping-on-to-electrics',
            nextStep: 'repair-leak-description-electrics-emergency',
          },
          {
            condition: 'containable-with-bucket',
            nextStep: 'repair-description-leak-inside',
          },
          {
            condition: 'not-containable',
            nextStep: 'repair-leak-description-electrics-emergency',
          },
        ],
      },
      'repair-description-leak-inside': {
        prevStep: 'repair-description-leak-electrics',
        nextStep: 'repair-description-leak-source',
      },
      'repair-description-leak-source': {
        prevStep: 'repair-description-leak-inside',
        nextStep: 'repair-description',
      },
      'repair-leak-description-electrics-emergency': {
        prevStep: 'repair-description-leak-electrics',
      },
      ...
      'contact-details': {
        prevStep: 'contact-person',
        nextStep: 'repair-availability',
      },
      'repair-availability': {
        prevStep: 'contact-details',
        nextStep: 'summary',
      },
  ...
  handleChange = (input, value, state) => {
    let repairProblemChanged =
      input == 'repairProblem' && state.data[input] != value
  ...
  _stepsFromUrl = () => {
    ...
    const flowNextStep = Object.keys(this.flow).find(
      (key) => this.flow[key].prevStep === urlStep
    )
    return {
