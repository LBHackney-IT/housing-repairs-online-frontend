    ...
    <div className="govuk-width-container">
      <div className="govuk-phase-banner lbh-phase-banner lbh-container">
        <p className="govuk-phase-banner__content">
          ...
          <span className="govuk-phase-banner__text">This is our new website design - it&apos;s work in progress.<a href="repairs-hub-support@hackney.gov.uk" title="Tell us what you think">Tell us what you think</a>, your feedback will help us to improve it.</span>
        </p>
      </div>
